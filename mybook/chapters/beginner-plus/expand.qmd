...
[Snakemake wildcards](./wildcards.qmd) make it easy to apply rules to
...
for rule `compare_genomes` from [Chapter 8](../ch08-new-genomes.qmd) - 
...
In [Chapter 9](../ch09-expand.qmd), we showed how to change this to a list of the
...
or a dictionary.  See the [Python appendix](../appendix/python.qmd) for
details.
...
[wildcard examples](wildcards.qmd).
