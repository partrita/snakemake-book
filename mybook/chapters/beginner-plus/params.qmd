...
[input and output blocks](input-and-output-blocks.qmd) are key to the
...
the standard [string formatting operations](string-formatting.qmd).
...
* [input functions & params functions](../recipes/params-functions.qmd)
