...
rule blocks; for example, in [Chapter 11](../ch11-final-snakefile.qmd), the
default rule 
...
For example, for the Snakefile from [Chapter 11](../ch11-final-snakefile.qmd),
...
Consider again the Snakefile from [Chapter 11](../ch11-final-snakefile.qmd). There
