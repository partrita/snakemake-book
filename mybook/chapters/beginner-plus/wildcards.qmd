...
As we showed in [Chapter 6](../ch06-wildcards.qmd), when you have repeated
...
[Using `expand` to generate filenames](expand.qmd).
...
when you use 
[global wildcard constraints](../reference/wildcard-constraints.qmd) to
...
[`params:` blocks and `{params}`](params-blocks.qmd)). Here, `wildcards`
...
[wildcard constraints](../reference/wildcard-constraints.qmd) to limit
wildcard matching.  See "Constraining wildcards to avoid
subdirectories and/or periods", below, for some examples, and see the
[wildcard constraints](../reference/wildcard-constraints.qmd) chapter
for more details!
...
See [Replacing for loops with Snakefiles](../recipes/replacing-for.qmd)
...
[Input and Output Blocks](input-and-output-blocks.qmd).)
...
See [Wildcard constraints](../reference/wildcard-constraints.qmd) for more
...
[Using expand to generate filenames](expand.qmd) for more information
on `zip` vs `product`.
